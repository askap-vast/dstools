...
`DStools` is _an ASA award-winning_ processing pipeline to produce and post-process dynamic spectrum data products from radio interferometer visibilities. `DStools` currently directly supports extraction of dynamic spectra from the following telescopes:
* ATCA
* ASKAP
* MeerKAT
* VLA
