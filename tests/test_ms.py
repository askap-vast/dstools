...
def test_get_reference_antenna_invalid_selection_prompts_user(ms, capfd, mocker):
...
def test_nspw_conversion_1to1(temp_environment):
...
def test_nspw_conversion_1to2(temp_environment):
    ms_path = temp_environment["onespw"]
    ms = MeasurementSet(path=ms_path)
...
def test_nspw_conversion_sequence(temp_environment):
    ms_path = temp_environment["onespw"]
    ms = MeasurementSet(path=ms_path)
...
def test_invalid_nspw_conversion_raises_error(temp_environment):
    ms_path = temp_environment["onespw"]
    ms = MeasurementSet(path=ms_path)
...
def test_ms_average_baselines(temp_environment):
    ms_path = temp_environment["onespw"]
    ms = MeasurementSet(path=ms_path)
...
def test_ms_rotate_phasecentre_inplace(temp_environment):
    ms_path = temp_environment["onespw"]
    ms = MeasurementSet(path=ms_path)
...
def test_ms_rotate_phasecentre(temp_environment):
    ms_path = temp_environment["onespw"]
    ms = MeasurementSet(path=ms_path)
...
def test_subtract_model_no_split(temp_environment):
    ms_path = temp_environment["onespw"]
    ms = MeasurementSet(path=ms_path)
    ...
    subtracted = MeasurementSet(ms_path.with_suffix(".subtracted.ms"))
...
def test_subtract_model_split(temp_environment):
    ms_path = temp_environment["onespw"]
    ms = MeasurementSet(path=ms_path)
...
def test_ms_increment_selfcal_round_initial(ms, ms_path):
    ms = MeasurementSet(path=ms_path)
    assert ms.increment_selfcal_round() == ms_path.with_suffix(".selfcal1.ms")
...
def test_ms_solve_gains(temp_environment):
    ms_path = temp_environment["onespw"]
    ms = MeasurementSet(path=ms_path)
